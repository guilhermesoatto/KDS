...
public static IServiceCollection AddSqlServerDependency(this IServiceCollection services)
{
  services
    .AddInfraDependency()
    .AddTnfDbContext<KDSApiDbContext>((config) =>
    {
...
```c#
public class KDSApiDbContext : TnfDbContext
{
  public DbSet<Customer> Customers { get; set; }

  // Importante o construtor do contexto receber as opções com o tipo generico definido: DbContextOptions<TDbContext>
  public KDSApiDbContext(DbContextOptions<KDSApiDbContext> options, ITnfSession session) 
...
```c#
public class KDSApiDbContextFactory : IDesignTimeDbContextFactory<KDSApiDbContext>
{
  public KDSApiDbContext CreateDbContext(string[] args)
  {
    var builder = new DbContextOptionsBuilder<KDSApiDbContext>();
