using KDSApi.Application;
using KDSApi.Domain;
using KDSApi.Domain.Entities;
using KDSApi.Dto;
using KDSApi.Infra;
using KDSApi.Infra.SqLite;
using KDSApi.Infra.SqlServer;
...
namespace KDSApi.Web
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services
                .AddCorsAll("AllowAll")
                .AddApplicationServiceDependency()  // dependencia da camada KDSApi.Application
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "KDSApi.Web.xml"));
            });
